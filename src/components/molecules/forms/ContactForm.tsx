        ...
        <div className="max-w-6xl w-full grid md:grid-cols-2 gap-24 bg-surface rounded-lg shadow-lg m-auto p-6 mb-6 lg:p-24">
            <div className="space-y-4">
                <div className="border-gray-700 border-b pb-4 space-y-3 mb-12">
                    ...
                    <p className="tracking-wide text-sm">
                        Let&apos;s connect! Whether it&apos;s a collaboration or a quick question,
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <textarea
                    ...
                    rows={4}
                    className="w-full p-3 bg-gray-700 border border-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"></textarea>
